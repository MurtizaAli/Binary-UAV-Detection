...
"""
Drone BINARY Detection based on 1D-R-CNN, Signal Processing Letters  (SPL)    
...
model = Sequential()
model.add(Conv1D(16, 64, activation='relu', input_shape=(35280, 1), padding='valid', strides=2))  #bases on the size of the feature used
model.add(MaxPooling1D(8))

model.add(Conv1D(32, 32, activation='relu',  padding='valid', strides=2))
model.add(MaxPooling1D(8))

model.add(Conv1D(64, 16, activation='relu',  padding='valid', strides=2))
model.add(MaxPooling1D(4))
model.add(Dropout(0.2))

model.add(Conv1D(256, 4, activation='relu',  padding='valid', strides=2))
model.add(Dropout(0.2))
model.add(Flatten())
...
# model.save("/home/user/Desktop/Drone Detection Pre-processing Data/Binary Drone Detection/1D_R_CNN_saved_model")
# del train_data
model = tf.keras.models.load_model("/home/user/Desktop/Drone Detection Pre-processing Data/Binary Drone Detection/1D_R_CNN_saved_model")
#%%
