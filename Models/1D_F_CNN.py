"""
Drone BINARY Detection based on 1D-F-CNN, Signal Processing Letters  (SPL)    
...
model = Sequential()
model.add(Conv1D(512, 3, activation='relu', input_shape=(20, 1), padding='same'))  #bases on the size of the feature used
